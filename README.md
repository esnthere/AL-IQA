...
### 2. Load pre-trained weight for test  
   ...
   The pre-trained models can be downloaded from: [Pre-trained models](链接：https://pan.baidu.com/s/111iPWcQ7baaC5b771ZQ3Aw?pwd=j7pq提取码：j7pq复制这段内容后打开百度网盘手机App，操作更方便哦). Please download these files and put them in the same folder of code and then run '**test_example_koniq_*n*percent.py**' to make intra/cross dataset test for models trained on *n%* samples.
